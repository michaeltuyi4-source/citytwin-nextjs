    ...
    <>
      ...
      <nav className="nav">
        ...
        <div className="nav-links">
          ...
          <Link className="nav-link" href="/#sample-match">See a match</Link>
      ...
      <main className="about">
        <article className="ab-inner">
          ...
          <p className="ab-body">I&apos;ve moved four times across the United States. Before that, I moved to America several years ago. So I know what it feels like to start over.</p>

          <p className="ab-body">Every move came with the same problem. Not the boxes, not the lease, not the logistics. The harder part: rebuilding a life from scratch in a place that didn&apos;t yet know you.</p>

          <p className="ab-body">I&apos;m not someone who thrives in crowds. I don&apos;t make friends at happy hours or random events. So when I moved from Illinois to Maryland, I tried everything anyway. Happy hours. Local meetups. Friendship apps. Parks. Showed up to things I didn&apos;t want to be at, hoping something would click.</p>

          <p className="ab-body ab-body-end">Nothing did. The connections never felt organic.</p>

          <blockquote className="ab-quote">
            I couldn&apos;t find a barber who could cut my hair. A gym with a track. An international grocery store with the food I grew up on. The things that quietly make a place feel like home.
          </blockquote>

          <p className="ab-body">Those aren&apos;t things you can search for on Zillow. They don&apos;t show up in a relocation packet. They&apos;re the texture of daily life, and they vanish when you move.</p>

          <p className="ab-body">Three years later I moved again, from Maryland to Virginia. That&apos;s when I stopped accepting that this was just how moving worked, and started building CityTwin.</p>

          <p className="ab-body">CityTwin is the tool I wish I&apos;d had every time I moved. It matches you to neighborhoods based on how you actually live (the rituals, the routines, the small things that make a place feel like yours). Not just walk scores and rent ranges. The barber. The gym. The grocery store. The people.</p>
        ...
        <div className="ft-top">
          ...
          <div className="ft-links">
            <div className="ft-col">
              ...
              <Link className="ft-link" href="/#how-it-works">How it works</Link>
              <Link className="ft-link" href="/#sample-match">See a match</Link>
              <Link className="ft-link" href="/#principles">Our principles</Link>
